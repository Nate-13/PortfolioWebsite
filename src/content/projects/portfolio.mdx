...
<Note>
**Update:** This page documents the original version of this website built with vanilla HTML, CSS, and JavaScript. The site has since been refactored using Next.js, TypeScript, Tailwind CSS, and MDX for a more modern, maintainable codebase.
</Note>
