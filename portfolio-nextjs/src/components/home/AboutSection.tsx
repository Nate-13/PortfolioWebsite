    ...
    <section id="about" className="h-auto w-full flex-col items-center justify-center pt-[5vw] max-lg:mt-[15vw]">
      ...
      <div className="flex w-full flex-row items-center justify-center">
        <button
          ...
          className="animate-pulse-primary mr-[1vw] flex h-12 w-auto cursor-pointer items-center justify-center rounded-[3vw] border-none bg-[var(--color-primary)] px-[5%] text-[2rem] font-bold text-[var(--color-secondary-light)] no-underline shadow-[0_0_0_var(--color-primary)] transition-all duration-200 hover:scale-[1.03] hover:bg-[var(--color-accent)] hover:text-[var(--color-secondary)] hover:[animation:paused] dark:bg-[var(--color-accent)] dark:text-[var(--color-bg-dark)] dark:shadow-[0_0_0_var(--color-accent)] dark:hover:bg-[var(--color-sun-dark)] max-lg:h-16 max-lg:rounded-[2.5rem] max-lg:text-[2rem]"
        >
          Download my Resume
        </button>
      </div>
